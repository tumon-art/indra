...
export default function AboutSection1() {
  return (
    <div
      className=" bg-dim lg:bg-white relative isolate
      sm:px-12 w-full py-5 sm:py-10"
    >
      <div
        className=" hidden lg:block absolute top-[-60px] h-[700px] 
      ...
      <div
       ...
       text-white lg:text-textDark 
      flex lg:inline-block overflow-hidden"
      >
        <div className=" rounded-md absolute w-3/5 h-full z-[-1] top-0 bg-primary "></div>
